...
Source0  : https://gstreamer.freedesktop.org/src/orc/orc-0.4.40.tar.xz
Source1  : https://gstreamer.freedesktop.org/src/orc/orc-0.4.40.tar.xz.asc
...
%setup -q -n orc-0.4.40
cd %{_builddir}/orc-0.4.40
pushd ..
cp -a orc-0.4.40 build32
popd
pushd ..
cp -a orc-0.4.40 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726181592
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/liborc-0.4.so.0.40.0
/V3/usr/lib64/liborc-test-0.4.so.0.40.0
/usr/lib64/liborc-0.4.so.0
/usr/lib64/liborc-0.4.so.0.40.0
/usr/lib64/liborc-test-0.4.so.0
/usr/lib64/liborc-test-0.4.so.0.40.0
