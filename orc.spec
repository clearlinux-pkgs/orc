...
Source0  : https://gstreamer.freedesktop.org/src/orc/orc-0.4.38.tar.xz
Source1  : https://gstreamer.freedesktop.org/src/orc/orc-0.4.38.tar.xz.asc
...
%prep
%setup -q -n orc-0.4.38
cd %{_builddir}/orc-0.4.38
pushd ..
cp -a orc-0.4.38 build32
popd
pushd ..
cp -a orc-0.4.38 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709078348
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/liborc-0.4.so.0.38.0
/V3/usr/lib64/liborc-test-0.4.so.0.38.0
/usr/lib64/liborc-0.4.so.0
/usr/lib64/liborc-0.4.so.0.38.0
/usr/lib64/liborc-test-0.4.so.0
/usr/lib64/liborc-test-0.4.so.0.38.0

%files lib32
%defattr(-,root,root,-)
/usr/lib32/liborc-0.4.so.0
/usr/lib32/liborc-0.4.so.0.38.0
/usr/lib32/liborc-test-0.4.so.0
/usr/lib32/liborc-test-0.4.so.0.38.0
