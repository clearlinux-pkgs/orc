...
Source0  : https://gstreamer.freedesktop.org/src/orc/orc-0.4.39.tar.xz
Source1  : https://gstreamer.freedesktop.org/src/orc/orc-0.4.39.tar.xz.asc
...
%setup -q -n orc-0.4.39
cd %{_builddir}/orc-0.4.39
pushd ..
cp -a orc-0.4.39 build32
popd
pushd ..
cp -a orc-0.4.39 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721410578
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/liborc-0.4.so.0.39.0
/V3/usr/lib64/liborc-test-0.4.so.0.39.0
/usr/lib64/liborc-0.4.so.0
/usr/lib64/liborc-0.4.so.0.39.0
/usr/lib64/liborc-test-0.4.so.0
/usr/lib64/liborc-test-0.4.so.0.39.0
