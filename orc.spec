...
Source0  : https://gstreamer.freedesktop.org/src/orc/orc-0.4.41.tar.xz
Source1  : https://gstreamer.freedesktop.org/src/orc/orc-0.4.41.tar.xz.asc
...
%setup -q -n orc-0.4.41
cd %{_builddir}/orc-0.4.41
pushd ..
cp -a orc-0.4.41 build32
popd
pushd ..
cp -a orc-0.4.41 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739891976
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/liborc-0.4.so.0.41.0
/V3/usr/lib64/liborc-test-0.4.so.0.41.0
/usr/lib64/liborc-0.4.so.0
/usr/lib64/liborc-0.4.so.0.41.0
/usr/lib64/liborc-test-0.4.so.0
/usr/lib64/liborc-test-0.4.so.0.41.0

%files lib32
%defattr(-,root,root,-)
/usr/lib32/liborc-0.4.so.0
/usr/lib32/liborc-0.4.so.0.41.0
/usr/lib32/liborc-test-0.4.so.0
/usr/lib32/liborc-test-0.4.so.0.41.0
