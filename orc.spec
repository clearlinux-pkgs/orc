...
Source0  : https://gstreamer.freedesktop.org/src/orc/orc-0.4.37.tar.xz
Source1  : https://gstreamer.freedesktop.org/src/orc/orc-0.4.37.tar.xz.asc
...
%prep
%setup -q -n orc-0.4.37
cd %{_builddir}/orc-0.4.37
pushd ..
cp -a orc-0.4.37 build32
popd
pushd ..
cp -a orc-0.4.37 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707766678
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/liborc-0.4.so.0.37.0
/V3/usr/lib64/liborc-test-0.4.so.0.37.0
/usr/lib64/liborc-0.4.so.0
/usr/lib64/liborc-0.4.so.0.37.0
/usr/lib64/liborc-test-0.4.so.0
/usr/lib64/liborc-test-0.4.so.0.37.0

%files lib32
%defattr(-,root,root,-)
/usr/lib32/liborc-0.4.so.0
/usr/lib32/liborc-0.4.so.0.37.0
